    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="container mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-[#005596] mb-2">TrustGPT</h1>
          <p className="text-lg text-[#00A4E4] font-medium italic">"Trust changes everything"</p>
          <p className="text-gray-600 mt-2 max-w-2xl mx-auto">
            Your AI companion for building trust in relationships, teams, and organizations. Inspired by Stephen M.R.
            Covey's principles from "The Speed of Trust".
          </p>
        </div>

        {/* Chat Container */}
        <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="border-b border-gray-100 bg-[#005596]/5">
            <div className="flex items-center gap-2">
              <MessageCircle className="h-5 w-5 text-[#005596]" />
              <span className="font-semibold text-[#005596]">Trust Conversation</span>
            </div>
          </CardHeader>
            ...
            <div className="h-[500px] overflow-y-auto p-6 space-y-4">
              {messages.length === 0 && (
                <div className="text-center py-12">
                  <div className="w-16 h-16 bg-[#00A4E4]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    <MessageCircle className="h-8 w-8 text-[#00A4E4]" />
                  </div>
                  <h3 className="text-lg font-semibold text-[#005596] mb-2">Welcome to TrustGPT</h3>
